        ...
        for i = #n, 1, -3 do
            ...
            if not val_p_r then
                if val_p >= 20 then
                    ...
                    val_p_r =
                        h ..
                        (numbers.tens[math.floor((val_p % 100) / 10)] or "") .. " " .. (numbers.ones[val_p % 10] or "")
                end
            end
    ...
    if #frac_v > 0 then
        ...
        elseif context.decimal == 1 and not context.financial then
            ...
            elseif #frac_v > 2 then
                d =
                    (((#frac_v % 3) == 2 and "hundred-") or ((#frac_v % 3) == 1 and "ten-") or "") ..
                    (numbers.decimal[context.scale][math.floor(#frac_v / 3)] or "")
            end
